...
const translations = {
  ...
  // Homepage
  "home.badge": { zh: "AI 驱动的个人化学习", en: "AI-Powered Personalized Learning" },
  ...
  "home.feature1.desc": { zh: "通过自然对话，AI 帮你量身定制学习路线", en: "AI customizes your learning path through natural conversation" },
  "home.feature2.title": { zh: "结构化课程", en: "Structured Courses" },
  "home.feature2.desc": { zh: "自动生成章节、课文、总结和测验", en: "Auto-generate chapters, lessons, summaries, and quizzes" },
  "home.feature3.title": { zh: "智能辅导", en: "AI Tutoring" },
  "home.feature3.desc": { zh: "每节课配备 AI 助教，随时解答疑问", en: "Each lesson has an AI tutor ready to answer questions" },
  "home.feature4.title": { zh: "进度追踪", en: "Progress Tracking" },
  "home.feature4.desc": { zh: "清晰的学习进度，让你始终掌控节奏", en: "Clear progress tracking keeps you on pace" },
  "home.topicsTitle": { zh: "你可以学习任何复杂主题", en: "Learn Any Complex Topic" },
  "home.footer": { zh: "StudyClaw - AI 驱动的个人化学习平台", en: "StudyClaw - AI-Powered Personalized Learning Platform" },

  // Dashboard
  "dash.title": { zh: "我的学习项目", en: "My Projects" },
  "dash.subtitle": { zh: "管理你的个人化学习计划", en: "Manage your personalized learning plans" },
  "dash.new": { zh: "新建项目", en: "New Project" },
  "dash.empty": { zh: "还没有学习项目", en: "No projects yet" },
  "dash.emptyHint": { zh: "点击「新建项目」开始你的第一个学习计划", en: "Click \"New Project\" to start your first learning plan" },
  ...
  "plan.subtitle": { zh: "和 AI 讨论你想学什么，它会帮你制定学习计划", en: "Discuss with AI what you want to learn" },
  "plan.creating": { zh: "创建中...", en: "Creating..." },
  "plan.create": { zh: "创建课程", en: "Create Course" },
  "plan.hint": { zh: "继续对话以完善计划，AI 准备就绪后「创建课程」按钮将亮起", en: "Keep chatting to refine the plan. The button will light up when AI is ready." },
  "plan.readyBanner": { zh: "🎉 课程计划已就绪！点击右上角「创建课程」按钮生成你的个人化课程", en: "🎉 Your course plan is ready! Click \"Create Course\" above to generate your personalized course" },
  ...
  "project.confirmHint": { zh: "确认后将自动为所有章节生成正文、总结和测验", en: "Content will be generated for all chapters after confirmation" },
  "project.confirmHintFirst": { zh: "确认后将为第一章生成内容，其余章节可单独生成", en: "First chapter will be generated. Other chapters can be generated individually." },
  "project.confirm": { zh: "确认计划", en: "Confirm Plan" },
  "project.generating": { zh: "正在生成内容...", en: "Generating content..." },
  "project.genWait": { zh: "生成过程可能需要几分钟，请勿关闭页面", en: "This may take a few minutes. Please don't close the page." },
  ...
  "delete.desc": { zh: "将永久删除此项目及其所有章节、内容和聊天记录。此操作无法撤销。", en: "This will permanently delete the project and all its chapters, content, and chat history. This cannot be undone." },
  ...
  "tutor.subtitle": { zh: "关于本节内容有任何问题都可以问我", en: "Ask me anything about this lesson" },
  ...
  "tutor.error": { zh: "抱歉，暂时无法回答，请稍后重试。", en: "Sorry, unable to answer right now. Please try again." },
